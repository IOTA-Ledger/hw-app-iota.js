...
var IOTA = function () {
  ...
  _createClass(IOTA, [{
    ...
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(transfers, inputs) {
        var remainder = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
        var balance, payment;
      ...
      function getSignedTransactions(_x6, _x7) {
