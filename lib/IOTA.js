...
var IOTA = function () {
  function IOTA(transport) {
    ...
    transport.decorateAppAPIMethods(this, ['setSeedInput', 'getAddress', 'signBundle'], 'IOT');
  }
  ...
  _createClass(IOTA, [{
    ...
    value: function () {
      ...
      function transaction(_x7, _x8, _x9, _x10, _x11, _x12, _x13) {
    ...
    value: function () {
      ...
      function signBundleResultToFragments(_x14) {
    ...
    value: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(bundle, security) {
      ...
      function addSignatureFragmentsToBundle(_x15, _x16) {
