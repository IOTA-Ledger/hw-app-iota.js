...
var IOTA = function () {
  function IOTA(transport) {
    ...
    this.security = 0;
    transport.decorateAppAPIMethods(this, ['setSeedInput', 'getAddress', 'getSignedTransactions', 'displayAddress', 'readIndexes', 'writeIndexes'], 'IOT');
  }
  ...
  _createClass(IOTA, [{
    ...
    key: 'transaction',
    value: function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(address, address_idx, value, tag, tx_idx, tx_len, tx_time) {
      ...
      function transaction(_x11, _x12, _x13, _x14, _x15, _x16, _x17) {
    ...
    value: function () {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 12:
                ...
                return _context9.abrupt('return', signatureFragments);
      ...
      function signBundleResultToFragments(_x18) {
    ...
    value: function () {
      ...
      function addSignatureFragmentsToBundle(_x19) {
    ...
    key: '_signBundle',
    value: function () {
      var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(options) {
    ...
    key: '_writeIndexes',
    value: function () {
      var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(indexes) {
        var indexStruct, buf, proxy, _this;
