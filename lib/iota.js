        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                setSeedInStruct = new _struct.default().word8('security').word32Ule('pathLength').array('pathArray', pathArray.length, 'word32Ule');
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                pubkeyInStruct = new _struct.default().word32Ule('index');
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                txInStruct = new _struct.default().chars('address', 81).word32Ule('address_idx').word64Sle('value').chars('tag', 27).word32Ule('tx_idx').word32Ule('tx_len').word32Ule('time');
                txInStruct.allocate();
              ...
              case 14:
                ...
                txOutStruct = new _struct.default().word8('finalized').chars('bundleHash', 81);
        ...
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                dispAddrInStruct = new _struct.default().word32Ule('index');
