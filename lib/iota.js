        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                (0, _validators.validate)([path, _bip32Path2.default.validateString, 'Invalid BIP32 path'], (0, _validators.securityLevelValidator)(security));
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                (0, _validators.validate)((0, _validators.arrayValidator)(_validators.transferValidator)(transfers), (0, _validators.arrayValidator)(_validators.inputValidator)(inputs), [remainder, isRemainder, 'Invalid remainder object']);
