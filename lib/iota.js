...
var _bundle = require('@iota/bundle');

var _checksum = require('@iota/checksum');

var _transactionConverter = require('@iota/transaction-converter');
...
var isRemainder = function isRemainder(remainder) {
  return (0, _validators.isHash)(remainder.address) && Number.isInteger(remainder.keyIndex) && remainder.keyIndex >= 0;
};
...
var Iota = function () {
  ...
  _createClass(Iota, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                (0, _validators.validate)((0, _validators.securityLevelValidator)(security));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                ...
                if (options.checksum) {
                  address = (0, _checksum.addChecksum)(address);
                }
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                (0, _validators.validate)((0, _validators.arrayValidator)(_validators.transferValidator)(transfers), (0, _validators.arrayValidator)(_validators.inputValidator)(inputs), [remainder, typeof remainder === 'undefined' || isRemainder, 'Invalid remainder object']);
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                timeout = tx_idx == tx_len ? TIMEOUT_CMD_USER_INTERACTION : TIMEOUT_CMD_NON_USER_INTERACTION;
                _context8.next = 13;
    ...
    value: function () {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                inputOffset = bundle.findIndex(function (_ref11) {
              ...
              case 4:
                ...
                _context10.t0 = fragments;
                _context10.next = 8;
                return this._getSignatureFragments(inputOffset + security * i);

              case 8:
                _context10.t1 = _context10.sent;
                fragments = _context10.t0.concat.call(_context10.t0, _context10.t1);
              ...
              case 13:
                return _context10.abrupt('return', (0, _bundle.addTrytes)(bundle, fragments, inputOffset));
      ...
      function _addSignatureFragmentsToBundle(_x21, _x22) {
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 32:
                _context11.next = 34;
                return this._addSignatureFragmentsToBundle(bundle, inputs);
    ...
    value: function () {
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                // remove checksums
                transfers.forEach(function (t) {
                  return t.address = (0, _checksum.removeChecksum)(t.address);
                });
                inputs.forEach(function (i) {
                  return i.address = (0, _checksum.removeChecksum)(i.address);
                });
                if (remainder) {
                  remainder.address = (0, _checksum.removeChecksum)(remainder.address);
                }
              ...
              case 5:
                ...
                transactions = transfers.reduce(function (acc, _ref14) {
                  var address = _ref14.address,
                      value = _ref14.value,
                      tag = _ref14.tag;
                  return (0, _bundle.addEntry)(acc, { address: address, value: value, timestamp: timestamp, tag: tag });
                }, transactions);
                transactions = inputs.reduce(function (acc, input) {
                  return (0, _bundle.addEntry)(acc, {
                    length: _this.security,
                ...
                if (remainder) {
                  transactions = (0, _bundle.addEntry)(transactions, {
                    address: remainder.address,
                    value: remainder.value,
                    timestamp: timestamp
                  });
                }
                transactions = (0, _bundle.finalizeBundle)(transactions);

                // map internal addresses to their index
                addressKeyIndices = {};

                inputs.forEach(function (_ref15) {
                  var address = _ref15.address,
                      keyIndex = _ref15.keyIndex;
                  return addressKeyIndices[address] = keyIndex;
                });
                if (remainder) {
                ...
                _context12.next = 16;
                return this._signBundle(transactions, inputs, addressKeyIndices);

              case 16:
                transactions = _context12.sent;
                return _context12.abrupt('return', (0, _transactionConverter.asFinalTransactionTrytes)(transactions));
      ...
      function _signTransaction(_x26, _x27, _x28) {
