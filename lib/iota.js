...
exports.getIOTAStatusMessage = getIOTAStatusMessage;
...
var Commands = { // specific timeouts:
...
var TIMEOUT_CMD_PUBKEY = 5000;
var TIMEOUT_CMD_NON_USER_INTERACTION = 5000;
var TIMEOUT_CMD_USER_INTERACTION = 90000;
...
function getIOTAStatusMessage(error) {
  ...
  if (error.id == "U2F_5") return "Ledger device timeout. Ensure Ledger is plugged in and IOTA app is running";
